...
import com.lee.leftmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
		...
		Log.d(TAG,"dispatchSelected:"+dispatchSelected);
		mCurItem = item;
		...
		Log.d(TAG,"smoothScroll:"+smoothScroll);
	...
	void smoothScrollTo(int x, int y, int velocity) {
		...
		Log.d(TAG, "startScroll-sx:"+sx+",sy:"+sy+",dx:"+dx+",dy:"+dy+",duration:"+duration+",x:"+x+",y:"+y);
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		Log.d(TAG, "mQuickReturn:"+mQuickReturn);
